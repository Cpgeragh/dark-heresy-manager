...
export const ARMOUR_REFERENCE: ArmourRef[] = [
  ...
  { id: "ih-banded-armour", name: "Banded Armour", source: SkillSource.IH, locations: ARMS_BODY_LEGS, ap: 3, qualities: PRIMITIVE, weight: "12 kg", value: "50 Thrones", availability: "Rare" },
  { id: "ih-bone-armour", name: "Bone Armour", source: SkillSource.IH, locations: ARMS_BODY_LEGS, ap: 2, qualities: PRIMITIVE, weight: "12 kg", value: "20 Thrones", availability: "Average" },
  { id: "ih-bracers", name: "Bracers", source: SkillSource.IH, locations: ARMS, ap: 1, qualities: PRIMITIVE, weight: "0.5 kg", value: "10 Thrones", availability: "Plentiful" },
  { id: "ih-heavy-plate-armour", name: "Heavy Plate Armour", source: SkillSource.IH, locations: ALL, ap: 6, qualities: PRIMITIVE, weight: "28 kg", value: "300 Thrones", availability: "Scarce" },
  { id: "ih-scale-armour", name: "Scale Armour", source: SkillSource.IH, locations: ARMS_BODY_LEGS, ap: 3, qualities: PRIMITIVE, notes: "Wearers gain a +10 bonus on Agility Tests made to avoid catching fire.", weight: "15 kg", value: "1,000 Thrones", availability: "Very Rare" },
  { id: "ih-scrag-furs", name: "Scrag Furs", source: SkillSource.IH, locations: ["body"], ap: 2, qualities: PRIMITIVE, notes: "A character wearing scrag furs takes a −10 penalty on all Fellowship Tests.", weight: "7 kg", value: "5 Thrones", availability: "Common" },
  { id: "ih-silkmail", name: "Silkmail", source: SkillSource.IH, locations: ARMS_BODY_LEGS, ap: 3, qualities: PRIMITIVE, weight: "5 kg", value: "150 Thrones", availability: "Rare" },
  { id: "ih-hardened-body-glove", name: "Hardened Body Glove", source: SkillSource.IH, locations: ARMS_BODY_LEGS, ap: 3, notes: "For three times the listed cost, hardened body gloves can also be purchased with a sealable hood (covering the head) and inherent stealth features, making the wearer harder to detect with auspexes, IR vision and the like (imposing a −20 penalty on Tests to notice the wearer).", weight: "5 kg", value: "300 Thrones", availability: "Rare" },
  { id: "ih-volcanis-shroud", name: "Volcanis Shroud", source: SkillSource.IH, locations: ALL, ap: 3, notes: "The protection provided by the shroud is doubled against fire, acids and corrosives. Unfortunately, because of its substantial bulk, the shroud also imposes a −10 penalty on Agility Tests while worn. The suit also has a built-in rebreather and photo-visor.", weight: "20 kg", value: "350 Thrones", availability: "Average" },
  { id: "ih-mirkers-greaves", name: "Mirker’s Greaves", source: SkillSource.IH, locations: LEGS, ap: 4, qualities: PRIMITIVE, notes: "The wearer can also kick with the same effect as if they were punching using knuckle dusters.", weight: "8 kg", value: "50 Thrones", availability: "Average" },
  { id: "ih-hax-orthlack-mkii-magistratum-combat-carapace", name: "Hax-Orthlack MKII Magistratum Combat Carapace", source: SkillSource.IH, locations: ALL, ap: 5, notes: "The suit of armour also has a built-in respirator, comm-bead and photo-visor.", weight: "16 kg", value: "1,100 Thrones", availability: "Rare" },
  { id: "ih-dragon-scale", name: "Dragon Scale", source: SkillSource.IH, locations: ALL, ap: 8, notes: "This armour includes a photo-visor and a respirator. In addition, it increases the wearer’s Strength Characteristic by +10. This armour requires the user to be fitted with a cyber-mantle and potentia coil.", weight: "20 kg", value: "7,500 Thrones", availability: "Tech-Priest Only" },

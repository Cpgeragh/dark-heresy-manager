...
export const RANGED_WEAPON_REFERENCE: RangedWeaponRef[] = [
  ...
  },
  {
    ...
    name: "Civitas",
    source: SkillSource.IH,
    class: "Pistol (Las)", range: "25m", rof: "S/2/–", damage: "1d10+1 E", pen: 0, clip: 25, reload: "Full", specialRules: "Reliable",
    description: "A simple utility weapon, the Civitas is a somewhat bulky and inefficient laspistol, but remains popular due to its ease of manufacture, longevity and simplicity of maintenance. These pistols are made on almost every major hive world for planetary defence armouries and civilian hands.",
    weight: "2 kg", value: "40 Thrones", availability: "Common",
    ammoType: "Charge Pack (Pistol)", compatibleAmmoIds: ["cr-charge-pack-pistol"], ammoTracking: "clip",
  },
  {
    id: "ih-death-light",
    name: "Death Light",
    source: SkillSource.IH,
    class: "Basic (Las)", range: "80m", rof: "S/3/–", damage: "1d10+5 E", pen: 2, clip: 18, reload: "Full", specialRules: "—",
    description: "The Death Light is an extremely powerful compact lasgun with a folding stock designed to fire high-energy blasts. Sollex weapons use standard power packs, but their more powerful charge gives them commensurately fewer shots. They can be hotshot or overcharged, but then become subject to the Overheats rule. Sollex weapons have Scarce Availability in Magnogorsk and are Very Rare elsewhere.",
    weight: "7.2 kg", value: "250 Thrones", availability: "Very Rare",
    ammoType: "Charge Pack (Basic)", compatibleAmmoIds: ["cr-charge-pack-basic"], ammoTracking: "clip",
  },
  {
    id: "ih-drusus-prime",
    name: "Drusus Prime",
    source: SkillSource.IH,
    class: "Basic (Las)", range: "100m", rof: "S/2/–", damage: "1d10+3 E", pen: 0, clip: 50, reload: "Full", specialRules: "—",
    description: "Made in large numbers for Calixis PDF use, the Drusus Prime is a local copy of the ubiquitous Ryza-M pattern lasgun. It is perhaps the most widely produced long arm in the sector, and is commonly found in the hands of gangers, criminals and low-grade guns for hire.",
    weight: "7 kg", value: "50 Thrones", availability: "Common",
    ammoType: "Charge Pack (Basic)", compatibleAmmoIds: ["cr-charge-pack-basic"], ammoTracking: "clip",
  },
  {
    id: "ih-duelling-las",
    name: "Duelling Las",
    source: SkillSource.IH,
    class: "Pistol (Las)", range: "30m", rof: "S/–/–", damage: "1d10+4 E", pen: 4, clip: 1, reload: "Full", specialRules: "Accurate, Tearing",
    description: "A handcrafted Khayer-Addin weapon designed around the ‘single shot kill’, using a unique charge cartridge that is, in essence, a pre-loaded hot-shot pack. The Valentine uses special single-shot cells rather than standard power packs. It cannot be combined with an overcharge pack or an additional hot-shot charge.",
    weight: "1.7 kg", value: "220 Thrones", availability: "Very Rare",
    ammoType: "Valentine Cell", compatibleAmmoIds: ["ih-valentine-cell"], ammoTracking: "loose",
  },
  {
    id: "ih-minerva-aegis",
    name: "Minerva-Aegis",
    source: SkillSource.IH,
    class: "Basic (Las)", range: "60m", rof: "S/4/8", damage: "1d10+2 E", pen: 0, clip: 40, reload: "Full", specialRules: "Reliable",
    description: "A sophisticated las carbine with a high cycle-charge chamber that allows a rapid pulse mode comparable to fully automatic fire. Produced under title to the Takara Fane of Gunmetal, it is a sign of discerning professionalism in a hired scummer.",
    weight: "4.1 kg", value: "150 Thrones", availability: "Scarce",
    ammoType: "Charge Pack (Basic)", compatibleAmmoIds: ["cr-charge-pack-basic"], ammoTracking: "clip",
  },
  {
    id: "ih-palatine",
    name: "Palatine",
    source: SkillSource.IH,
    class: "Pistol (Las)", range: "20m", rof: "S/3/–", damage: "1d10+2 E", pen: 0, clip: 20, reload: "Full", specialRules: "Reliable",
    description: "Thanks to advanced manufacture, the Palatine loses no stopping power despite being half the size of most military-model laspistols. It has been produced exclusively for the last century by the Takara Fane of Gunmetal.",
    weight: "1.1 kg", value: "100 Thrones", availability: "Average",
    ammoType: "Charge Pack (Pistol)", compatibleAmmoIds: ["cr-charge-pack-pistol"], ammoTracking: "clip",
  },
  {
    ...
    name: "Series-S Venom",
    source: SkillSource.IH,
    class: "Pistol (Las)", range: "10m", rof: "S/–/–", damage: "1d10+1 E", pen: 0, clip: 15, reload: "—", specialRules: "—",
    description: "A highly compact laspistol designed for covert use. It takes the shape of a flat disk grasped in the hand, with the short barrel-emitter projecting between the middle fingers. It does not use standard power packs; its internal power cell must be recharged between uses via a standard port.",
    weight: "0.5 kg", value: "120 Thrones", availability: "Scarce",
  },
  {
    id: "ih-steel-burner",
    name: "Steel Burner",
    source: SkillSource.IH,
    class: "Pistol (Las)", range: "30m", rof: "S/–/–", damage: "1d10+4 E", pen: 2, clip: 10, reload: "Full", specialRules: "—",
    description: "This hugely powerful Sollex laspistol is known as a ‘las-hand cannon’. It uses standard power packs but gains fewer shots from them; it can be hotshot or overcharged, but then becomes subject to the Overheats rule. Sollex weapons are Scarce in Magnogorsk and Very Rare elsewhere.",
    weight: "2.5 kg", value: "100 Thrones", availability: "Very Rare",
    ammoType: "Charge Pack (Pistol)", compatibleAmmoIds: ["cr-charge-pack-pistol"], ammoTracking: "clip",
  },
  {
    id: "ih-gorge-gl",
    name: "Gorge GL",
    source: SkillSource.IH,
    class: "Basic (Launcher)", range: "60m", rof: "S/–/–", damage: "Ammunition-dependent", pen: "Ammunition-dependent", clip: 1, reload: "2 Full", specialRules: "Reliable; ammunition-dependent",
    description: "A simply made, single-shot break-open grenade launcher. Damage, Penetration, and any other special qualities are determined by the ammunition fired, such as a grenade.",
    weight: "8 kg", value: "300 Thrones", availability: "Average",
  },
  {
    id: "ih-melta-cutter",
    name: "Melta-Cutter",
    source: SkillSource.IH,
    class: "Basic (Melta)", range: "10m", rof: "S/–/–", damage: "2d10+4 E", pen: 10, clip: 5, reload: "3 Full", specialRules: "—",
    description: "An extremely large and cumbersome industrial cutting and welding tool. Its 10 metre range is an absolute maximum, and it gains no bonus for firing at short range. A user requires Strength Bonus 4 or more to use it effectively; weaker characters suffer a –10 WS penalty for every point of Strength Bonus below 4.",
    weight: "30 kg", value: "600 Thrones", availability: "Scarce",
    ammoType: "Melta Canister (basic)", compatibleAmmoIds: ["cr-melta-canister-basic"], ammoTracking: "clip",
  },
  {
    id: "ih-drive-nailer",
    name: "Drive Nailer",
    source: SkillSource.IH,
    class: "Basic (Primitive)", range: "5m", rof: "–/3/–", damage: "1d10+1 R", pen: 4, clip: 15, reload: "3 Full", specialRules: "Primitive",
    description: "A high-power nail or rivet-driving gun common to hive construction and reclamation crews. With its power setting turned up and safety features disabled, it can make a messy but effective weapon.",
    weight: "7 kg", value: "50 Thrones", availability: "Common",
  },
  {
    id: "ih-impaler",
    name: "Impaler",
    source: SkillSource.IH,
    class: "Heavy (Primitive)", range: "30m", rof: "S/–/–", damage: "1d10+5 I", pen: 2, clip: 1, reload: "2 Full", specialRules: "Primitive, Unreliable",
    description: "Also known as the ‘harpoon cannon’, the Impaler launches a metal spear capable of punching straight through a human body. A Strength Bonus of at least 4 is required to operate its reloading mechanism.",
    weight: "22 kg", value: "100 Thrones", availability: "Scarce",
  },
  {
    id: "ih-scrap-cannon",
    name: "Scrap Cannon",
    source: SkillSource.IH,
    class: "Heavy (Primitive)", range: "15m", rof: "S/–/–", damage: "1d10+3 R", pen: 0, clip: 1, reload: "3 Full", specialRules: "Scatter, Unreliable",
    description: "A crudely reinforced pipe packed with black powder, nails, bolts, and anything else nasty scraped from the underhive floor. Anyone successfully hit must Test for Pinning. Scrap cannon are Very Rare outside the Underhive and Average within it.",
    weight: "40 kg", value: "150 Thrones", availability: "Very Rare",
  },
  // ── Inquisitor's Handbook — Hive Worlds, Solid Projectile ───────────────
  {
    id: "ih-armageddon", name: "Armageddon", source: SkillSource.IH, class: "Basic (SP)", range: "100m", rof: "S/2/6", damage: "1d10+4 I", pen: 0, clip: 15, reload: "Full", specialRules: "Reliable",
    description: "A loud, lethal, uncomplicated heavy-hitter for an autogun. It fires large-calibre solid slugs from a fifteen-round short box clip and can stand a phenomenal amount of abuse and keep firing.", weight: "8.5 kg", value: "100 Thrones", availability: "Average", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-armsman-10", name: "Armsman-10", source: SkillSource.IH, class: "Pistol (SP)", range: "35m", rof: "S/3/–", damage: "1d10+3 I", pen: 0, clip: 13, reload: "Full", specialRules: "—",
    description: "A bulky, intimidating, high-capacity stub pistol and a common sidearm for enforcers, household troops, and mercenaries throughout the Calixis Sector.", weight: "1.5 kg", value: "50 Thrones", availability: "Plentiful", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-blackhammer", name: "Blackhammer", source: SkillSource.IH, class: "Basic (SP)", range: "20m", rof: "S/–/–", damage: "2d10 I", pen: 0, clip: 1, reload: "2 Full", specialRules: "Inaccurate, Scatter",
    description: "A single-shot shotgun firing a custom-made massive shell. It imposes an additional –10 to hit unless the firer has Strength Bonus 4 or more or the weapon is braced. Its shells count as Exotic ammunition.", weight: "4.7 kg", value: "250 Thrones", availability: "Rare", ammoType: "Exotic", compatibleAmmoIds: ["cr-exotic"], ammoTracking: "loose",
  },
  {
    id: "ih-carnodon", name: "Carnodon", source: SkillSource.IH, class: "Pistol (SP)", range: "35m", rof: "S/3/–", damage: "1d10+4 I", pen: 2, clip: 6, reload: "Full", specialRules: "Accurate",
    description: "A finely made and well-balanced precision hand cannon, powerful and extremely accurate in skilled hands. Ownership and the ability to use one are marks of high status among the criminal gangs of the Scintillan hives.", weight: "2.5 kg", value: "200 Thrones", availability: "Scarce", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-vi-crank-cannon", name: "VI Crank Cannon", source: SkillSource.IH, class: "Heavy (SP)", range: "70m", rof: "–/–/5", damage: "1d10+5 I", pen: 0, clip: 100, reload: "3 Full", specialRules: "Unreliable",
    description: "A hand-powered heavy stubber: the firer cranks the firing handle to grind ammunition belts through the breach and rotate its quad barrels. It is produced in huge numbers on Fenksworld.", weight: "38 kg", value: "500 Thrones", availability: "Average", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-creed-9", name: "Creed-9", source: SkillSource.IH, class: "Basic (SP)", range: "50m", rof: "S/3/10", damage: "1d10+3 I", pen: 0, clip: 35, reload: "Full", specialRules: "—",
    description: "A compact autogun designed for close-quarter warfare, favoured by enforcer kill squads and private armies. It is common to see Creeds fitted with upgrades such as red-dot sights, expanded mag-ports, and fire selectors.", weight: "3.6 kg", value: "115 Thrones", availability: "Average", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-encarmine", name: "Encarmine", source: SkillSource.IH, class: "Pistol (SP)", range: "20m", rof: "S/3/8", damage: "1d10 I", pen: 0, clip: 24, reload: "Full", specialRules: "—",
    description: "A sophisticated autopistol that sacrifices stopping power for a reduction in size and increase in clip capacity. It is widely carried for personal defence and by plainclothes enforcers, hauler rig crews, and merchants’ factors.", weight: "2 kg", value: "90 Thrones", availability: "Average", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-fate-bringer", name: "Fate Bringer", source: SkillSource.IH, class: "Pistol (SP)", range: "40m", rof: "S/–/–", damage: "1d10+3 I", pen: 2, clip: 5, reload: "2 Full", specialRules: "Accurate, Reliable",
    description: "An elegant and perfectly balanced stub revolver, used to settle ‘affairs of honour’ among the nobles of Sibellus. It also makes a good target and assassination pistol.", weight: "1.6 kg", value: "200 Thrones", availability: "Rare", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-flametongue", name: "Flametongue", source: SkillSource.IH, class: "Pistol (SP)", range: "20m", rof: "S/–/–", damage: "1d10+6 I", pen: 0, clip: 2, reload: "2 Full", specialRules: "Primitive, Reliable",
    description: "A compact twin-barrelled hand cannon chambered for huge custom-made soft-alloy rounds that break apart on impact. Flametongue rounds count as Exotic ammunition with the Primitive quality.", weight: "2 kg", value: "140 Thrones", availability: "Rare", ammoType: "Exotic", compatibleAmmoIds: ["cr-exotic"], ammoTracking: "loose",
  },
  {
    id: "ih-hack-shotgun", name: "Hack Shotgun", source: SkillSource.IH, class: "Pistol (SP)", range: "10m", rof: "S/–/–", damage: "1d10+4 I", pen: 0, clip: 1, reload: "2 Full", specialRules: "Inaccurate, Scatter, Tearing",
    description: "A double-barrel shotgun cut down to the smallest possible size and rigged to fire both barrels from a single trigger pull. It uses two shotgun shells at once; if loaded with one shell, it inflicts only 1d10+4 Damage and loses Tearing.", weight: "3 kg", value: "60 Thrones", availability: "Common", ammoType: "Shells", compatibleAmmoIds: ["cr-shells", "ih-blazer-shotgun-shells", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-hecuter", name: "Hecuter", source: SkillSource.IH, class: "Pistol (SP)", range: "30m", rof: "S/3/6", damage: "1d10+3 I", pen: 0, clip: 15, reload: "Full", specialRules: "Reliable",
    description: "A large-calibre heavy combat autopistol, tooled and balanced to exact tolerances. Despite its size, its excellent design makes it an easy carry from shoulder rigs and quick-draw holsters.", weight: "2 kg", value: "175 Thrones", availability: "Average", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-mariette", name: "Mariette", source: SkillSource.IH, class: "Pistol (SP)", range: "20m", rof: "S/–/–", damage: "2d5+3 I", pen: 0, clip: 1, reload: "2 Full", specialRules: "—",
    description: "An extremely concealable compact stub pistol made from polyflex and ceramics with no metallic or powered components. Disassembled and hidden, it is virtually impossible to find (–30 penalty on Search Tests) and does not show up on scanners or auspexes as a weapon. Its ammunition-barrel cylinders are Rare and cost 100 Thrones each.", weight: "0.5 kg", value: "400 Thrones", availability: "Rare", ammoType: "Mariette Cylinder", compatibleAmmoIds: ["ih-mariette-cylinder"], ammoTracking: "loose",
  },
  {
    id: "ih-mercy-killer", name: "Mercy Killer", source: SkillSource.IH, class: "Pistol (SP)", range: "20m", rof: "S/–/–", damage: "1d10+2 I", pen: 0, clip: 1, reload: "2 Full", specialRules: "Inaccurate, Unreliable",
    description: "A crude, often scratch-built single-shot stub pistol, fashioned from whatever materials are to hand. It is wildly inaccurate and often as dangerous to its firer as its target.", weight: "1 kg", value: "10 Thrones", availability: "Plentiful", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-meat-hammer", name: "Meat Hammer", source: SkillSource.IH, class: "Basic (SP)", range: "30m", rof: "S/–/–", damage: "2d5+6 I", pen: 0, clip: 1, reload: "3 Full", specialRules: "Scatter, Tearing",
    description: "A triple-barrelled open-choke shotgun designed to destroy a living body with a single blast. Although its clip is listed as 1, it takes three shotgun shells to load.", weight: "5 kg", value: "80 Thrones", availability: "Scarce", ammoType: "Shells", compatibleAmmoIds: ["cr-shells", "ih-blazer-shotgun-shells", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-nomad", name: "Nomad", source: SkillSource.IH, class: "Basic (SP)", range: "250m", rof: "S/–/–", damage: "1d10+5 I", pen: 3, clip: 4, reload: "Full", specialRules: "Accurate, Reliable",
    description: "A famous Gunmetal hunting instrument, made only to commission and personalised to its purchaser. Its perfect workmanship and capability to empty a carnosaur’s brainpan at two miles makes it worth every Throne.", weight: "10 kg", value: "2,000 Thrones", availability: "Very Rare", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-phobos-stubber", name: "Phobos Stubber", source: SkillSource.IH, class: "Pistol (SP)", range: "30m", rof: "S/3/–", damage: "1d10+3 I", pen: 0, clip: 9, reload: "Full", specialRules: "—",
    description: "A cheap, commonplace stub automatic made in the tens of thousands and found across the Imperium, from underhive scav-traders to frontier mining camps and Administratum supply depots.", weight: "1.3 kg", value: "50 Thrones", availability: "Plentiful", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-puritan-14", name: "Puritan-14", source: SkillSource.IH, class: "Pistol (SP)", range: "20m", rof: "S/3/6", damage: "1d10+2 I", pen: 0, clip: 14, reload: "Full", specialRules: "—",
    description: "A squat dual-barrelled autopistol with an integral single shotgun cartridge chamber. It can fire as either an autopistol or shotgun, but not both at once. In shotgun mode, it imposes a –10 Ballistic Skill penalty unless used with two hands.", weight: "1.7 kg", value: "100 Thrones", availability: "Scarce", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
    alternateProfiles: [{ label: "Shotgun", range: "15m", rof: "S/–/–", damage: "1d10+4 I", pen: 0, clip: 1, reload: "Full", specialRules: "Scatter", ammoType: "Shells" }],
  },
  {
    id: "ih-ripper-clip", name: "Ripper Clip", source: SkillSource.IH, class: "Pistol (SP)", range: "20m", rof: "–/–/6", damage: "1d10+2 I", pen: 0, clip: 12, reload: "Full", specialRules: "Inaccurate, Unreliable",
    description: "A bulky, cheaply made autopistol using basic stub rounds. Its distinctive vertical strip of bullets rattles through the weapon and ends with a clatter as the spent strip hits the floor. Ripper Clips are Common on Volg and Scarce elsewhere.", weight: "3 kg", value: "40 Thrones", availability: "Scarce", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-salvation", name: "Salvation", source: SkillSource.IH, class: "Pistol (SP)", range: "10m", rof: "S/3/–", damage: "1d10 I", pen: 0, clip: 7, reload: "—", specialRules: "—",
    description: "An extremely compact, self-contained personal-defence handgun. Its internal magazine cannot be reloaded without partly dismantling the pistol, earning it a reputation as a disposable toy.", weight: "0.7 kg", value: "80 Thrones", availability: "Common",
  },
  {
    id: "ih-scalptaker", name: "Scalptaker", source: SkillSource.IH, class: "Pistol (SP)", range: "30m", rof: "S/–/–", damage: "1d10+3 I", pen: 0, clip: 6, reload: "2 Full", specialRules: "Reliable",
    description: "A robust, utilitarian stub revolver that fires true after almost any amount of abuse and mistreatment, making it a popular backup sidearm for professionals, frightened hivers, and frontier colonists.", weight: "2 kg", value: "40 Thrones", availability: "Plentiful", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-slayer", name: "Slayer", source: SkillSource.IH, class: "Basic (SP)", range: "30m", rof: "S/–/–", damage: "1d10+4 I", pen: 0, clip: 6, reload: "3 Full", specialRules: "Scatter",
    description: "A classically functional pump shotgun, originally intended as a back-up weapon for vehicle crews and PDF troopers, but now common throughout Calixis.", weight: "3.5 kg", value: "70 Thrones", availability: "Average", ammoType: "Shells", compatibleAmmoIds: ["cr-shells", "ih-blazer-shotgun-shells", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-spectre", name: "Spectre", source: SkillSource.IH, class: "Basic (SP)", range: "80m", rof: "S/3/10", damage: "1d10+3 I", pen: 0, clip: 20, reload: "Full (each)", specialRules: "—",
    description: "An autogun with a tri-mag shot-selection system and an integral shotgun unit. It can fire as either an autogun or shotgun, but not both during the same Action. It has three magazines and a fire selector.", weight: "6.5 kg", value: "375 Thrones", availability: "Rare", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose", magazineSlots: 3,
    alternateProfiles: [{ label: "Shotgun", range: "30m", rof: "S/–/–", damage: "1d10+4 I", pen: 0, clip: 4, reload: "2 Full", specialRules: "Scatter", ammoType: "Shells" }],
  },
  {
    id: "ih-steadholder", name: "Steadholder", source: SkillSource.IH, class: "Basic (SP)", range: "100m", rof: "S/–/–", damage: "1d10+4 I", pen: 0, clip: 6, reload: "Full", specialRules: "—",
    description: "A heavy-calibre rifle loaded by a simple, distinctive lever mechanism. Although intended for frontier settlements and agri-worlds, it has spread to black markets and Redemptionists due to its ease of use and low cost.", weight: "5 kg", value: "60 Thrones", availability: "Plentiful", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-stormchild", name: "Stormchild", source: SkillSource.IH, class: "Pistol (SP)", range: "35m", rof: "S/–/–", damage: "1d10+4 I", pen: 2, clip: 5, reload: "2 Full", specialRules: "—",
    description: "A scaled-up stub revolver with a hinged breach and five-shot cylinder, capable of demolishing armoured targets and crippling civilian vehicles. Its size and robust construction allow it to be used as a club in close combat without damaging it.", weight: "3 kg", value: "65 Thrones", availability: "Average", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
    alternateMeleeProfiles: [{ label: "Club", damage: "1d10 I", pen: 0, specialRules: "Primitive" }],
  },
  {
    id: "ih-talon-mark-iii", name: "Talon Mark III", source: SkillSource.IH, class: "Pistol (SP)", range: "30m", rof: "S/2/6", damage: "1d10+2 I", pen: 0, clip: 18, reload: "Full", specialRules: "—",
    description: "A medium-calibre fully automatic caseless cartridge pistol of sturdy, practical design. It can use an extended 30-round clip, but then cannot be holstered and must be fired two-handed or suffers a further –10 Ballistic Skill penalty.", weight: "2.3 kg", value: "70 Thrones", availability: "Common", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-54-tranter", name: ".54 Tranter", source: SkillSource.IH, class: "Pistol (SP)", range: "30m", rof: "S/2/–", damage: "1d10+5 I", pen: 2, clip: 7, reload: "Full", specialRules: "Unreliable",
    description: "A massive gas-operated stub automatic, powerful but prone to jamming. Without Strength Bonus 4 or more, it counts as a Basic weapon and must be used with two hands. It Jams on a roll of 94–00.", weight: "3.5 kg", value: "95 Thrones", availability: "Common", ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  ...
  },
  {
    ...
    compatibleAmmoIds: ["cr-plasma-flask-pistol"],
    ammoTracking: "clip",
    alternateProfiles: [{ label: "Maximal", range: "40m", rof: "S/–/–", damage: "1d10+10 E", pen: 6, clip: 10, reload: "4 Full", specialRules: "Overheats, Recharge", ammoType: "Plasma Flask (pistol)" }],
  },
  {
  ...
  },
  {
    ...
    compatibleAmmoIds: ["cr-shells", "ih-blazer-shotgun-shells", "ih-blessed-ammunition"],
    ammoTracking: "loose",
    alternateMeleeProfiles: [{ label: "Club", damage: "1d10-2 I", pen: 0, specialRules: "Primitive" }],
  },
  {
  ...
  },
  {
    ...
    availability: "Rare",
    ammoType: "Bullets",
    compatibleAmmoIds: ["ih-irontalon-fragmenting-ammunition", "cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"],
    ammoTracking: "loose",
    alternateMeleeProfiles: [{ label: "Club", damage: "1d10 I", pen: 0, specialRules: "Primitive" }],
  },
  {
  ...
  // ── Inquisitor's Handbook — War Zone: Bolt, Flame and Las ────────────────
  {
    ...
    reload: "Full",
    specialRules: "—",
    description: "Often brandished by Commissars, these large and intimidating weapons are designed to be carried unholstered and in easy sight of their charges. All Guardsmen, regardless of rank, know that their Commissar is watching their actions and is ready to grant summary execution to those found wanting in the Emperor’s eyes. Service pistols are a constant reminder of what awaits them if they fail in their duty.",
    weight: "4.5 kg",
    value: "350 Thrones",
    availability: "Rare",
    ammoType: "Bolt Shells",
  ...
  },
  {
    ...
    reload: "Full",
    specialRules: "Reliable",
    description: "Favoured by the warrior-sisters of the Order of the Ebon Chalice at the Abbey of Dawn on Iocanthos, the Scourge comes equipped with a sarissa as the bayonet fixture. The sharp spiked attachment can easily rip open any heretic in the hands of a power-armoured Adepta Sororitas fighter. When used in close combat, a Mars Pattern boltgun counts as a monoaxe.",
    weight: "10 kg",
    value: "650 Thrones",
    availability: "Very Rare",
    ammoType: "Bolt Shells",
    compatibleAmmoIds: ["cr-bolt-shells", "ih-psycannon-bolts", "ih-blessed-ammunition"],
    ammoTracking: "loose",
    alternateMeleeProfiles: [{ label: "Monoaxe", damage: "1d10+1 R", pen: 2, specialRules: "Unbalanced" }],
  },
  {
  ...
  },
  {
    ...
    reload: "Full",
    specialRules: "Reliable",
    description: "This rare variant is most often utilised by elite assault squads and the Fury is the ideal weapon when facing a horde of foes. They fire in short bursts, designed to clear away enemies without slowing the advance.",
    weight: "1.5 kg",
    value: "100 Thrones",
    availability: "Scarce",
    ammoType: "Charge Pack (Pistol)",
  ...
  },
  {
    ...
    reload: "Full",
    specialRules: "Reliable",
    description: "Standard issue for many Imperial Guard regiments across the Imperium since M.36, the blocky MK III lasgun is a remarkably robust and easy to use weapon. Legendarily able to stand up to any amount of abuse and keep firing, the ‘Guardsman’s Friend’ as the Uplifting Primer calls it, is respected over more powerful shoulder arms for its practicality and extreme reliability in almost any condition. The Mars pattern is produced in great numbers on Scintilla and Malfi and is the standard armament of most Calixian Guard regiments.",
    weight: "4 kg",
    value: "75 Thrones",
    availability: "Average",
    ammoType: "Charge Pack (Basic)",
  ...
  },
  {
    ...
    reload: "Full",
    specialRules: "Accurate, Reliable",
    description: "Presented to officers when they attain company commands, these are high-powered weapons designed for carefully placed shots at longer ranges. They have an extended barrel and are slightly heavier than standard service pistols.",
    weight: "1.75 kg",
    value: "150 Thrones",
    availability: "Rare",
    ammoType: "Charge Pack (Pistol)",
  ...
  },
  {
    ...
    reload: "Full",
    specialRules: "Reliable",
    description: "An unusual pattern, the Roth ‘Lightning’ has its ammunition plug set behind the trigger grip, allowing for a extended collimation barrel which provides greater ranges without increasing the overall size. Owing to their relative rarity, these weapons are often restricted to ‘sharpshooter’ light infantry regiments and many are further modified into long las sniper rifles.",
    weight: "4 kg",
    value: "175 Thrones",
    availability: "Rare",
    ammoType: "Charge Pack (Basic)",
  ...
  },
  {
    ...
    compatibleAmmoIds: ["cr-charge-pack-basic"],
    ammoTracking: "clip",
    alternateMeleeProfiles: [{ label: "Spear", damage: "1d10 R", pen: 0, specialRules: "Primitive, Two-Handed", twoHanded: true }],
  },
  {
  ...
  },
  {
    ...
    reload: "—",
    specialRules: "By ammunition",
    description: "This weapon is popular with PDF forces as it is simple to use and requires no loading or reloading. These weapons normally come pre-loaded with a single frag or krak missile. Some disposable launchers come loaded with rocket-propelled frag or krak grenades instead—these versions are half the normal cost.",
    weight: "30 kg",
    value: "800 Thrones",
    availability: "Rare",
    ammoType: "Missiles",
  },
  {
    ...
    reload: "Full",
    specialRules: "By ammunition",
    description: "The most powerful launcher weapon, they fire a variety of specialised rounds at long distances. Each missile is fitted with stabilization and guidance systems to aid their accuracy.",
    weight: "35 kg",
    value: "3,000 Thrones",
    availability: "Scarce",
    ammoType: "Missiles",
  ...
  },
  {
    ...
    reload: "2 Full",
    specialRules: "—",
    description: "Somewhat larger than the standard melta gun, it fires a more accurate and directed heat beam. The longer barrel provides for added directional containment to reduce dispersal, but at the cost of reduced firepower.",
    weight: "10 kg",
    value: "2,500 Thrones",
    availability: "Very Rare",
    ammoType: "Melta Canister (basic)",
  ...
  },
  {
    ...
    reload: "2 Full",
    specialRules: "—",
    description: "A more refined melta weapon, a thermal lance uses additional magnetic containment beams to guide the superheated flow through an extended barrel, resulting in less dispersion and tighter control. It is often used for precise cutting, but doubles nicely as a weapon for slicing through armour and bulkheads in focused cuts.",
    weight: "14 kg",
    value: "3,000 Thrones",
    availability: "Rare",
    ammoType: "Melta Canister (basic)",
  ...
  },
  {
    ...
    description: "A unique variant crafted as a combi-weapon, it incorporates two plasma guns which, when fired together, give twice the effective damage, but also at a higher risk to the user. The guns share the same fuel canisters, lowering the weight of the weapon but keeping the number of shots it can fire to roughly the same as a regular plasma gun.",
    weight: "20 kg",
    value: "7,500 Thrones",
    availability: "Very Rare",
    ammoType: "Plasma Flask (basic)",
  ...
  },
  {
    ...
    reload: "5 Full",
    specialRules: "Overheats, Recharge, Unreliable",
    description: "Most often seen on Imperial vehicles, a plasma cannon requires a large separate fuel container. It can also be fired in maximal mode, which consumes six shots worth of fuel but provides a blast of solar heat on impact, creating a fireball of stellar temperatures.",
    weight: "38 kg",
    value: "8,500 Thrones",
    availability: "Very Rare",
    ammoType: "Plasma Flask (basic)",
    compatibleAmmoIds: ["cr-plasma-flask-basic"],
    ammoTracking: "clip",
    alternateProfiles: [{ label: "Maximal", range: "120m", rof: "S/–/–", damage: "4d10+10 E", pen: 8, clip: 16, reload: "5 Full", specialRules: "Blast (3) (in addition); consumes 6 shots", ammoType: "Plasma Flask (basic)" }],
  },
  {
  ...
  // ── Inquisitor's Handbook — War Zone: Solid Projectile ───────────────────
  {
    ...
    source: SkillSource.IH,
    class: "Basic (SP)", range: "60m", rof: "S/–/10", damage: "1d10+3 I", pen: 0, clip: 40, reload: "Full", specialRules: "—",
    description: "This weapon is popular with PDF forces across the sector, where the simple setting (one shot or full automatic) fits better with the generally less well-trained soldiers. The larger magazine size helps keep up with the higher rate of shooting.",
    weight: "3.5 kg", value: "95 Thrones", availability: "Average",
    ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    ...
    name: "Assault Cannon",
    source: SkillSource.IH,
    class: "Heavy (SP)", range: "120m", rof: "–/–/10", damage: "3d10+5 I", pen: 5, clip: 200, reload: "2 Full", specialRules: "Tearing, Unreliable",
    description: "Assault cannons are equipped with six rapidly rotating barrels in a gatling-style configuration firing diamantine tipped shells. The barrels wear out quickly due to the intense heat generated by the internal motor that spins them, and normally require replacements after each mission to prevent jamming or catastrophic failure.\n\nAssault cannons are nasty for their sheer rate of fire that lets them progressively ‘chew’ through targets.",
    weight: "60 kg", value: "7,000 Thrones", availability: "Very Rare",
    ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    id: "ih-autocannon",
    name: "Autocannon",
    source: SkillSource.IH,
    class: "Heavy (SP)", range: "300m", rof: "S/2/5", damage: "4d10+5 I", pen: 4, clip: 20, reload: "2 Full", specialRules: "—",
    description: "An autocannon is a very brutal weapon, noisy and hard to control in action, and requires a team of two operators (firer and loader) for effective use. Autocannons use cased, explosive shells fired at a high rate to destroy their target. On the battlefield they provide excellent infantry support.",
    weight: "55 kg", value: "1,000 Thrones", availability: "Scarce",
    ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
    ...
    source: SkillSource.IH,
    class: "Pistol (SP)", range: "30m", rof: "S/3/–", damage: "1d10+3 I", pen: 0, clip: 9, reload: "Half", specialRules: "—",
    description: "Awarded by many Calixian regiments as a commendation for the lower ranks, pistols of this type were first taken as battlefield trophies during the Second Insurrection of Cantus centuries ago. Relics from that fabled war are highly valued, but most Guard veterans are content with a more modern copy, awarded as they are for valour in the face of the foe.",
    weight: "1.5 kg", value: "150 Thrones", availability: "Rare",
    ammoType: "Bullets", compatibleAmmoIds: ["cr-bullets", "ih-void-rounds", "ih-blessed-ammunition"], ammoTracking: "loose",
  },
  {
...
export const MELEE_WEAPON_REFERENCE: MeleeWeaponRef[] = [
  ...
  },
  {
    ...
    specialRules: "Power Field",
    twoHanded: true,
    description: "As the name suggests these blades are longer than normal power swords, requiring two hands to wield effectively. They are popular among the Brontian Longknives.",
    weight: "4.5 kg",
    value: "3,500 Thrones",
    availability: "Very Rare",
  },
  {
    ...
    pen: 0,
    specialRules: "Primitive",
    description: "These oversized bladed weapons are almost to the size of a short sword. Each has a heavy, straight-edged blade designed to cut flesh as well as puncture light armour, and can be affixed to most basic weapons as a bayonet.",
    weight: "0.8 kg",
    value: "40 Thrones",
    availability: "Average",
  },
  ...
  },
  {
    ...
    pen: 1,
    specialRules: "Balanced, Primitive",
    description: "Many fighters use the remains of their kill to fashion a memento of the action, and xenos fighters are no exception. A thriving secondary business goes on in many regiments where claws and teeth from alien creatures are removed and honed into valuable weapons. Each is a unique creation representing some of the monstrous races that have threatened the sector, some even unknown by scholars. They serve to show off the battlefield prowess of a warrior to their fellow troopers.",
    weight: "0.3 kg",
    value: "700 Thrones",
    availability: "Very Rare",
  },
...
export function resolveRangedWeaponReference(id?: string): RangedWeaponRef | undefined {
  ...
  return resolvedId ? RANGED_WEAPON_REFERENCE.find((weapon) => weapon.id === resolvedId) : undefined;
}
...
export const GRENADE_REFERENCE: GrenadeRef[] = [
  ...
  // ── Inquisitor's Handbook — War Zone Grenades, Missiles and Mines ─────────
  {
    ...
    value: "75 Thrones",
    availability: "Average",
    description: "This is a heavier version of the frag grenade designed primarily as an anti-personnel weapon. Frag missiles can only be used in missile launchers.",
  },
  {
  ...
  },
  {
    ...
    value: "150 Thrones",
    availability: "Average",
    description: "Used as tank-killers, there is little that can survive a direct hit from a krak missile. Krak missiles can only be used in missile launchers.",
  },
  {
    ...
    value: "10 Thrones",
    availability: "Scarce",
    description: "Gunmetal is known for producing a slightly heavier version grenade, ideal where a larger blast is needed. These grenades can be purchased to be used either by hand (thrown) or in grenade or RPG launchers.",
  },
  {
    id: "ih-stun-grenade",
    name: "Stun Grenade",
    ...
    value: "40 Thrones",
    availability: "Scarce",
    description: "Designed to incapacitate and disorient rather than kill, a stun grenade’s concussive effect, thunderous noise and bright flash is highly effective and usually causes no lasting injury. Anyone caught in a stun grenade’s blast must pass a Challenging (+0) Toughness Test or become Stunned for 1d5 Rounds. Photo-visors and sealed armour provide a +20 bonus to this Test.",
  },
  {
    ...
    value: "55 Thrones",
    availability: "Scarce",
    description: "A less powerful and less expensive directional explosive similar to the melta bomb, it is applied directly to the target structure and focuses the blast against it. The resulting explosion is more powerful than a regular krak detonation. When a limpet mine explodes, it deals 4d10 X Damage to anything within one metre, with a Penetration of 8.",
  },
  {
    id: "ih-melta-bomb",
    name: "Melta Bomb",

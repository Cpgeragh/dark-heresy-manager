...
export const TRAIT_LIST: readonly TraitData[] = [
  ...
  {
    id: "homeworld-iron-stomach",
    name: "Iron Stomach",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-primitive",
    name: "Primitive",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-rite-of-passage",
    name: "Rite of Passage",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-wilderness-savvy",
    name: "Wilderness Savvy",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-accustomed-to-crowds",
    name: "Accustomed to Crowds",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-caves-of-steel",
    name: "Caves of Steel",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-hivebound",
    name: "Hivebound",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  ...
  {
    id: "homeworld-blessed-ignorance",
    name: "Blessed Ignorance",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-hagiography",
    name: "Hagiography",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-liturgical-familiarity",
    name: "Liturgical Familiarity",
    source: SkillSource.CR,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-superior-origins",
  ...
  {
    id: "homeworld-stranger-to-the-cult",
    name: "Stranger to the Cult",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-credo-omnissiah",
    name: "Credo Omnissiah",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-schola-education",
    name: "Schola Education",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-skill-at-arms",
    name: "Skill at Arms",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-sheltered-upbringing",
    name: "Sheltered Upbringing",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-tempered-will",
    name: "Tempered Will",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-etiquette",
    name: "Etiquette",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-supremely-connected",
  ...
  {
    id: "homeworld-engram-implantation",
    name: "Engram Implantation",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-failsafe-control",
    name: "Failsafe Control",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-imperial-conditioning",
    name: "Imperial Conditioning",
    source: SkillSource.IH,
    hasSpecialisation: false,
  },
  {
    id: "homeworld-through-a-mirror-darkly",

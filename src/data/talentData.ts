...
export const TALENT_LIST: readonly TalentData[] = [
  ...
  { id: "daemon-trap",           name: "Daemon Trap",           source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Repel Daemon" },
  { id: "divine-endurance",      name: "Divine Endurance",      source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith" },
  { id: "divine-guidance",       name: "Divine Guidance",       source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Wrath of the Righteous" },
  { id: "divine-ministration",   name: "Divine Ministration",   source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith" },
  { id: "divine-symbol",         name: "Divine Symbol",         source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Daemon Trap" },
  { id: "divine-touch",          name: "Divine Touch",          source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, The Passion, Divine Guidance" },
  ...
  { id: "flames-of-faith",       name: "Flames of Faith",       source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Wrath of the Righteous" },
  { id: "focus-of-the-justicar", name: "Focus of the Justicar", source: SkillSource.BoM, hasSpecialisation: false },
  { id: "grace",                 name: "Grace",                 source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith" },
  ...
  { id: "hand-of-the-emperor",   name: "Hand of the Emperor",   source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith" },
  ...
  { id: "holy-light",            name: "Holy Light",            source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Holy Radiance" },
  { id: "holy-radiance",         name: "Holy Radiance",         source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith" },
  ...
  { id: "light-of-the-emperor",  name: "Light of the Emperor",  source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Holy Radiance" },
  ...
  { id: "martyrs-gift",          name: "Martyr's Gift",          source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith" },
  { id: "mental-calm",           name: "Mental Calm",           source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Grace" },
  { id: "might-of-the-emperor",  name: "Might of the Emperor",  source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Hand of the Emperor, The Passion" },
  { id: "minor-daemonym",        name: "Minor Daemonym",        source: SkillSource.BoM, hasSpecialisation: false },
  { id: "miraculous-recovery",   name: "Miraculous Recovery",   source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Divine Ministration" },
  { id: "miraculous-survival",   name: "Miraculous Survival",   source: SkillSource.BoM, hasSpecialisation: false },
  { id: "no-rest-for-the-faithful", name: "No Rest for the Faithful", source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Respite" },
  ...
  { id: "religious-hysteria",    name: "Religious Hysteria",    source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Righteous Frenzy" },
  { id: "repel-daemon",          name: "Repel Daemon",          source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Holy Radiance, Soul Decay" },
  { id: "respite",               name: "Respite",               source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Divine Endurance" },
  { id: "resurrection",          name: "Resurrection",          source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Divine Ministration, No Rest for the Faithful" },
  { id: "revelation",            name: "Revelation",            source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Mental Calm" },
  { id: "righteous-frenzy",      name: "Righteous Frenzy",      source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Wrath of the Righteous, The Passion" },
  { id: "rite-of-banishment",    name: "Rite of Banishment",    source: SkillSource.BoM, hasSpecialisation: false },
  { id: "seal-of-purity",        name: "Seal of Purity",        source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Divine Symbol" },
  ...
  { id: "the-passion",           name: "The Passion",           source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Divine Guidance" },
  { id: "the-unforgiving-blade", name: "The Unforgiving Blade", source: SkillSource.BoM, hasSpecialisation: false, prerequisites: "Pure Faith, Wrath of the Righteous" },

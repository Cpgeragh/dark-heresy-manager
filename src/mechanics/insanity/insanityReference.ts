...
export const INSANITY_TRACK: InsanityTrackEntry[] = [
  ...
  },
  {
    ...
    traumaModifier: "n/a",
    disorderLabel: "Retired from Play",
    terminal: true,
  },
];
...
export const MENTAL_TRAUMAS: MentalTraumaEntry[] = [
  ...
  {
    roll: "71-100",
    name: "Fearful and Jumpy",
    effect:
      "The character is constantly fearful, seeing danger everywhere and extremely jumpy. The character gains a +10 bonus to all Perception-based Tests and is at -10 penalty to his Willpower for the next 1d5 days.",
  },
  {
    roll: "101-120",
    name: "Temporary Phobia",
    effect: "The character suffers from a temporary severe phobia. This effect lasts for 1d5 days.",
  },
  {
    roll: "121-130",
    name: "Extremely Agitated",
    effect:
      "The character reacts to the slightest stress or pressure by becoming extremely agitated. When performing any task that involves a Test, the character must first pass a Willpower Test or suffer a -10 modifier to the Test. If the character gets into combat, all Tests during combat automatically suffer a -10 modifier. This effect lasts for 1d5 days.",
  },
  {
    roll: "131-140",
    name: "Extreme Nightmares",
    effect:
      "The character suffers vivid and extreme nightmares whenever they try to sleep. The next day and for the next 1d10 days the character will be exhausted by lack of sleep and gains a level of Fatigue. This effect lasts for 1d5 days.",
  },
  {
    roll: "141-150",
    name: "Struck Dumb",
    effect: "The character is struck dumb and is unable to speak. This lasts for 1d5 days.",
  },
  {
    roll: "151-160",
    name: "Refuses to Eat or Drink",
    effect:
      "Extremely distressed and unfocused, the character refuses to eat or drink and looks in a terrible state. The character takes a -10 penalty to all Characteristics (no Characteristic can be reduced below 1) for 1d10 days.",
  },
  {
    roll: "161-170",
  ...
  {
    roll: "171+",
    name: "Completely Traumatised",
    effect:
      "The character becomes completely traumatised and virtually unresponsive. He can't initiate actions but may be gently led. This effect lasts for 1d10 days.",
  },
];
...
export const INSANITY_RULE_TEXT = {
  ...
  trauma:
    "Mental Trauma represents the relatively short-term damage to a character's state of mind that he suffers after experiencing a horrific or supernatural event. Each time the character gains 10 Insanity Points he must make a Trauma Test. This is a Willpower Test, modified by the current Trauma Modifier. If the Test is passed the character manages to cope with his experience without extra ill effect. If the Test is failed, roll d100 and add 10 for every degree of failure, then compare the result to the Mental Traumas table.",
  recovery:
  ...
  disorders:
    "Mental disorders reflect the permanent, long-term effects on a character's mind of exposure to things horrific and unnatural. A new disorder (or a more severe version of an existing disorder) is automatically gained each time the character has enough Insanity Points to increase his degree of madness by one stage. When a character acquires a disorder, the severity of that disorder will depend on his new degree of madness, as shown.",
};
...
export const INSANITY_SEVERITIES: Array<{
...
}> = [
  {
    severity: "Minor",
    description:
      "The effects of the disorder manifest rarely or are experienced only to a small degree. Any Test to overcome the effects of the disorder gains a +10 bonus.",
  },
  {
    severity: "Severe",
    description:
      "The effects of the disorder are stronger and may occur regularly. There is no modifier to Tests made to overcome the effects of the disorder.",
  },
  {
    severity: "Acute",
    description:
      "The effects of the disorder are very strong and occur at the slightest stimulation. Any Test to overcome the effects of the disorder takes a -10 penalty.",
  },
];
...
export const INSANITY_DISORDER_REFERENCE: InsanityDisorderRef[] = [
  ...
  {
    id: "phobia-fear-of-the-dead",
    type: "Phobia",
    name: "Fear of the Dead",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: PHOBIA_TEXT,
    description:
  ...
  {
    id: "phobia-fear-of-insects",
    type: "Phobia",
    name: "Fear of Insects",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: PHOBIA_TEXT,
    description:
  ...
  },
  {
    ...
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: PHOBIA_TEXT,
    description: "Define a custom focus for the character's phobia.",
    custom: true,
  },
  {
    id: "obsession-kleptomania",
    type: "Obsession/Compulsion",
    name: "Kleptomania",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: OBSESSION_TEXT,
    description:
  ...
  {
    id: "obsession-self-mortification",
    type: "Obsession/Compulsion",
  ...
  },
  {
    id: "obsession-custom",
    type: "Obsession/Compulsion",
    name: "Custom Obsession/Compulsion",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: OBSESSION_TEXT,
    description: "Define a custom obsession or compulsive action for the character.",
    custom: true,
  },
  {
    id: "visions-dead-comrade",
    type: "Visions and Voices",
    name: "Dead Comrade",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: VISIONS_TEXT,
    description:
  ...
  },
  {
    id: "visions-custom",
    type: "Visions and Voices",
    name: "Custom Visions and Voices",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: VISIONS_TEXT,
    description: "Define a custom vision, voice, or intrusive hallucination for the character.",
    custom: true,
  },
  {
    id: "delusion-invulnerability",
    type: "Delusion",
    name: "Invulnerability",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: DELUSION_TEXT,
    description:
      "The character believes that he will never get severely injured, either through luck or divine providence.",
  },
  {
    id: "delusion-righteousness",
    type: "Delusion",
    name: "Righteousness",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: DELUSION_TEXT,
    description:
      "The character believes his choices are right and justified, no matter what the cost.",
  },
  {
    id: "delusion-custom",
    type: "Delusion",
    name: "Custom Delusion",
    severityOptions: ["Minor", "Severe", "Acute"],
    typeDescription: DELUSION_TEXT,
    description: "Define a custom false belief for the character.",
    custom: true,
  },
  {
    id: "horrific-nightmares",
    type: "Horrific Nightmares",
    name: "Horrific Nightmares",
    severityOptions: ["Minor", "Severe"],
    description:
      "The character suffers from vivid and reoccurring nightmares. After any stressful day, the character must pass a Willpower Test in order not to succumb to his terrors while asleep. If he fails, the character suffers a single level of Fatigue on the following day.",
  },
];
...
export function getDisorderSeverityOptions(
...
export function getNextDisorderSeverity(
  disorder: InsanityDisorderEntry
): InsanityDisorderSeverity | undefined {

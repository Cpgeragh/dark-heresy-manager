...
export function SkillCard({
  ...
  return (
    <div className="rounded border border-slate-700 bg-slate-900/40 px-3 py-2 space-y-2">
      {/* HEADER — identity + primary total */}
        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400">
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                className="w-16 rounded border border-slate-700 bg-slate-800 px-1 py-0.5 text-xs text-slate-200"
              />
            </div>
          ...
          <div>
            <textarea
              ...
              className="w-full min-h-[36px] resize-y rounded border border-slate-700 bg-slate-900 px-2 py-1 text-xs text-slate-200"
            />
          </div>
        </>
      )}

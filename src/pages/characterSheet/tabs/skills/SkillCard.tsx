...
export function SkillCard({
    ...
    return (
        <div className="border border-slate-700 bg-slate-900/40 rounded px-3 py-2 space-y-2">
            ...
            <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span
                        className={`px-1.5 py-0.5 rounded text-[10px] ${skill.advanced
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                        {([
                            ...
                            <button
                                ...
                                className={`px-2 py-1 rounded border ${skill.level === value

// src/pages/CharacterSheet/DrugsTab/CustomDrugForm.tsx
...
export function CustomDrugForm({
  ...
  const quantityValid =
    !includeQuantity || (Number.isInteger(quantityNumber) && quantityNumber >= 1);
  ...
  return (
    ...
    >
      ...
      <CustomFormSection title="Origin">
        <OriginSelector name="custom-drug-origin" value={origin} onChange={setOrigin} hideLabel />
      </CustomFormSection>
      ...
      <CustomFormSection title="Rules">
        <div className="grid grid-cols-2 gap-2">
          <div className="col-span-2">
            <label htmlFor="custom-drug-rules" className={uiFormLabel}>
              Rules
            </label>
            <textarea

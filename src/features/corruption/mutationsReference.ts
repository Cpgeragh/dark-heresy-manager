...
export const MINOR_MUTATIONS: MutationRef[] = [
  ...
  },
  {
    ...
    roll: "61-70",
    name: "Nightsider",
    effect: "The mutant gains the Dark Sight trait, but suffers a -10 penalty to all Actions in bright light or daylight conditions unless its eyes are shielded.",
  },
  {
    id: "big-eyes",
    roll: "71-80",
  ...
  },
  {
    ...
    roll: "90-99",
    name: "Wyrdling",
    effect: "The mutant has Minor Psychic Powers that it has so far been able to conceal. The mutant has a Psy Rating of 1. See Chapter VI: Psychic Powers.",
  },
  {
    id: "roll-major",
    roll: "100",
...
export const MAJOR_MUTATIONS: MutationRef[] = [
  ...
  },
  {
    ...
    roll: "41-50",
    name: "Ravaged Body",
    effect: "The mutant's body has been entirely re-made by the warp. Roll 1d5 times on Table 12-3: Minor Mutations, re-rolling duplicate rolls. Such mutations, regardless of their nature, still show the obvious taint of Chaos.",
  },
  {
    id: "clawed-fanged",
    roll: "51-60",
    name: "Clawed/Fanged",
    effect: "The mutant gains razor claws, a fanged maw, barbed flesh or some other form of Natural Weapon that inflicts 1d10 R or I Primitive damage in close combat.",
  },
  {
    id: "necrophage",
    roll: "61-65",
  ...
  },
  {
    ...
    effect: "Beneath the mutant's skin a blasphemous transformation has taken place, exchanging living organs for writhing creatures and blood for ichorous, maggot-ridden filth. If the mutant suffers Critical Damage, those witnessing it must take a Fear Test at -10.",
  },
  {
    id: "vile-alacrity",
    roll: "71-75",
  ...
  },
  {
    ...
    effect: "The mutant has sprouted additional functioning limbs in the shape of arms, tentacles or a prehensile tail, or tails. Gain the Ambidextrous and Two-Weapon Wielder talents and +10 bonus on Climb Tests and Grapple attacks.",
  },
  {
    id: "worm",
    roll: "86-90",
    name: "Worm",
    effect: "The mutant's lower limbs have fused together to form a worm or snake-like tail. They gain the Crawler trait, +5 Wounds and the Disturbing trait.",
  },
  {
    id: "nightmarish",
    roll: "91-92",
    name: "Nightmarish",
    effect: "So warped and horrific is the mutant's appearance, it can cause enemies to flee in fear. It gains the Frightening trait.",
  },
  {
    id: "malleable",
    roll: "93-94",
  ...
  },
  {
    ...
    roll: "95-96",
    name: "Winged",
    effect: "The mutant's body has warped to accommodate a pair of leathery wings or the like. They gain the Flyer trait (1d10+5).",
  },
  {
    id: "corpulent",
    roll: "97-98",
    name: "Corpulent",
    effect: "The mutant's huge and bloated frame gives them +5 Wounds and the Unnatural Toughness (x2) trait. This mutation means that the mutant may not run.",
  },
  {
    id: "corrosive-bile",
    roll: "99",
    name: "Corrosive Bile",
    effect: "The mutant may vomit burning bile, flesh-eating grubs or some other horrific substance instead of attacking normally in close combat. The attack uses the mutant's BS, is a Full Action and can be Dodged but not Parried. This attack inflicts 1d10+5 R (or E) Tearing Damage.",
  },
  {
    id: "hellspawn",
    roll: "00",
    name: "Hellspawn",
    effect: "Saturated with the energies of the warp, the mutant is imbued with Daemonic energies and gains the From Beyond, Frightening and Daemonic traits and a Psy Rating of 2.",
  },
];

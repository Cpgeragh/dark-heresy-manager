...
export function computeCharacterSummary(characterData: Record<string, unknown>): CharacterSummaryFields {
  ...
  if (typeof characterData.portraitUrl === "string") summary.portraitUrl = characterData.portraitUrl;
  return summary;
}

// tests/integration/CustomArcheotechForm.test.tsx
import { describe, it, expect, vi } from "vitest";
import { render, screen } from "@testing-library/react";
import userEvent from "@testing-library/user-event";
import "@testing-library/jest-dom";

import { CustomArcheotechForm } from "../../src/pages/CharacterSheet/ArcheotechTab/CustomArcheotechForm";

function renderForm(props: Partial<React.ComponentProps<typeof CustomArcheotechForm>> = {}) {
  const onAdd = vi.fn();
  const onCancel = vi.fn();
  render(<CustomArcheotechForm onAdd={onAdd} onCancel={onCancel} {...props} />);
  return { onAdd, onCancel };
}

describe("ArcheotechTab CustomArcheotechForm", () => {

...
describe("validateNumberRange", () => {
  it("accepts value within range", () =>
    expect(validateNumberRange(5, 0, 10)).toEqual({ isValid: true }));
  it("accepts boundary min", () =>
    expect(validateNumberRange(0, 0, 10)).toEqual({ isValid: true }));
  it("accepts boundary max", () =>
    expect(validateNumberRange(10, 0, 10)).toEqual({ isValid: true }));
...
describe("validateStringLength", () => {
  it("accepts string within bounds", () =>
    expect(validateStringLength("hello", 1, 10)).toEqual({ isValid: true }));
  it("rejects too short", () => expect(validateStringLength("hi", 5, 10).isValid).toBe(false));
  it("rejects too long", () =>
    expect(validateStringLength("hello world", 1, 5).isValid).toBe(false));
  it("accepts at exact min", () =>
    expect(validateStringLength("hi", 2, 10)).toEqual({ isValid: true }));
  it("accepts at exact max", () =>
    expect(validateStringLength("hello", 1, 5)).toEqual({ isValid: true }));
});
...
describe("validateCharacteristicTotal", () => {
  it("accepts base 95 + advances 1 = 100", () =>
    expect(validateCharacteristicTotal(95, 1)).toEqual({ isValid: true }));
  it("rejects base 96 + advances 1 = 101", () =>
    expect(validateCharacteristicTotal(96, 1).isValid).toBe(false));
  it("accepts base 100 + advances 0", () =>
    expect(validateCharacteristicTotal(100, 0)).toEqual({ isValid: true }));
});

describe("validateWounds", () => {
  it("accepts current equal to total", () =>
    expect(validateWounds(10, 10)).toEqual({ isValid: true }));
  it("accepts current less than total", () =>
    expect(validateWounds(5, 10)).toEqual({ isValid: true }));
  it("accepts zero current", () => expect(validateWounds(0, 10)).toEqual({ isValid: true }));
  it("rejects current greater than total", () =>
    expect(validateWounds(11, 10).isValid).toBe(false));
...
describe("validateFatePoints", () => {
  it("accepts current equal to total", () =>
    expect(validateFatePoints(3, 3)).toEqual({ isValid: true }));
  it("accepts current less than total", () =>
    expect(validateFatePoints(1, 3)).toEqual({ isValid: true }));
  it("rejects current greater than total", () =>
    expect(validateFatePoints(4, 3).isValid).toBe(false));
...
describe("validateRecoveryCode", () => {
  it("accepts valid format DH-XXXX-YYYY", () =>
    expect(validateRecoveryCode("DH-ABCD-1234")).toEqual({ isValid: true }));
  it("rejects empty", () => expect(validateRecoveryCode("").isValid).toBe(false));
  it("rejects missing DH prefix", () =>
    expect(validateRecoveryCode("AB-XXXX-YYYY").isValid).toBe(false));
  it("rejects too few segments", () => expect(validateRecoveryCode("DH-XXXX").isValid).toBe(false));
  it("rejects extra segments", () =>
    expect(validateRecoveryCode("DH-ABCD-1234-EXTRA").isValid).toBe(false));
  it("rejects short segments", () =>
    expect(validateRecoveryCode("DH-ABC-1234").isValid).toBe(false));
  it("rejects punctuation", () => expect(validateRecoveryCode("DH-ABC!-1234").isValid).toBe(false));
  it("rejects lowercase codes", () =>
    expect(validateRecoveryCode("dh-abcd-1234").isValid).toBe(false));
...
describe("validateCampaignName", () => {
  ...
  it("rejects over 100 characters", () =>
    expect(validateCampaignName("A".repeat(101)).isValid).toBe(false));
  it("accepts exactly 100 characters", () =>
    expect(validateCampaignName("A".repeat(100))).toEqual({ isValid: true }));
});

describe("validateCharacterName", () => {
  it("accepts normal name", () =>
    expect(validateCharacterName("Brother Mordecai")).toEqual({ isValid: true }));

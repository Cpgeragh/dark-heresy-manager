...
deletion (14.9 s), campaign deletion (11.1 s), concurrent numeric adjustment (9.1 s), the former
identity-recovery migration (9.0 s), and custom-item mutation (8.8 s). Character deletion was effectively identical
